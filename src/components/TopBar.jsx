    ...
    <div className="border-bottom py-2 small">
      <div className="container d-flex align-items-center justify-content-between">
        <div className="d-flex align-items-center gap-2">
          <span
            className="text-danger d-inline-flex align-items-center justify-content-center rounded-circle bg-light-subtle"
        ...
        <div>
          <img src="\public\logo.svg" alt="Cake Store Logo" />
        </div>
