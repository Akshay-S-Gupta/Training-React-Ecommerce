          ...
          {filteredCakes.length === 0 ? (
            ...
            filteredCakes.map((cake, idx) => {
              ...
              return (
                ...
                >
                  <span
                    className={`cart-icon${hoveredCard === idx ? " visible" : ""}`}
                    onClick={() => addToCart({...cake,image:cake.images[0]})}
                    style={{ cursor: "pointer" }}
                  >
                    {inCart ? (
                      <img src="/images/tick.png" alt="added" />
                    ) : (
                      <img src="/images/cart.png" alt="cart" />
                    )}
                  </span>
                  <img
                    src={hoveredCard === idx ? cake.images[carouselIdx] : cake.images[0]}
                    alt={cake.name}
                  ...
                  <div className="product-info">
                    ...
                    <div className="price-row">
                      {cake.oldPrice && (
                        <span className="product-old-price">${cake.oldPrice.toFixed(2)}</span>
                      )}
